        ...
        <div className="mt-10 px-3 mx-auto w-full max-w-sm">
          <form className="space-y-6" action="#" method="POST">
            ...
            <div>
              <button
                type="submit"
                className="flex w-full mb-10 justify-center rounded-md bg-purple-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-yellow-500 hover:text-purple-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600 mb-10"
              >
                Sign Up
              </button>
            </div>
